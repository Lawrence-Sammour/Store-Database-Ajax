...
$sql = "SELECT products.productDescription FROM products WHERE products.productDescription like '%some%' OR products.productDescription like '%one%' OR products.productDescription like '%more%';";
...
$result = $conn->query($sql);
	...
	<table class="table" style =" margin: 35px 65px; width: 90%;">
		...
		echo '  <th class="table-light" >productDescription </th>';
