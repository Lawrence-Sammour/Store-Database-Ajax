    ...
    <div class="row">
        <div class="column left" style=" padding: 30px 75px 0px 90px;">
            <div class="container">
                ...
                <input style="width: 170px;" type="text" id="officeCode" name="officeCode"><br><br>
               
                <label for="city">city:</label>
                <input style="width: 170px;" type="text" id="city" name="city"><br><br>
               
                <label for="state">state:</label>
                <input style="width: 170px;" type="text" id="state" name="state"><br><br>
                        ...
                        $("#btn-search").click(function() {
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    ...
                                    let text = "<table class='table' style =' margin: 35px 65px; width: 90%;'><tr><th>officeCode</th><th>city</th><th>state</th><th>country</th></tr>"
                                    for (let x in myObj) {
                                        text += "<tr>" +
                                            "<td class='table-light'>" + myObj[x].officeCode + "</td>" +
                                            "<td class='table-light'>" + myObj[x].city + "</td>" +
                                            "<td class='table-light'>" + myObj[x].state + "</td>" +
