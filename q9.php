...
$sql = "SELECT employeeNumber, CONCAT(employees.firstName, \" \", employees.lastName) AS Name FROM employees WHERE employees.employeeNumber NOT IN ( SELECT DISTINCT customers.salesRepEmployeeNumber FROM customers WHERE customers.salesRepEmployeeNumber IS NOT NULL) ORDER BY employeeNumber ASC;";
...
$result = $conn->query($sql);
	...
	<table class="table" style =" margin: 35px 65px; width: 90%;">
		...
		echo '  <th class="table-light" >Name</th>';
